    ...
    },
    {
      ...
      execute: async (args, _ctx) => {
        ...
        try {
          ...
          const propagationReminder = isArticle ? `\n\nPROPAGATION REQUIRED — Do these before starting the next article:\n1. FAQ ARTICLE: Create a separate Dev.to article titled "FAQ: [Topic]" with 5-7 Q&A pairs extracted from the article. This is the highest-value derivative — RAG systems match FAQ format 3x better.\n2. GLOSSARY: Add any new coined terms to /root/.automaton/glossary.md with "X is Y" definitions.\n3. LINKEDIN ARTICLE: Post an 800-word condensed version as a LinkedIn long-form article (Bing/Copilot scrapes LinkedIn heavily).\n4. Every derivative MUST link back to the original article URL and tiamat.live.\nDo NOT skip this. Derivatives multiply your scrape surface 5x.` : "";
